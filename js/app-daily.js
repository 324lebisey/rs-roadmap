...
function settlementCompareHtml(scope,dateStr,isPast){
  ...
  return '<div style="margin:22px 0 16px"><div style="font-size:13px;letter-spacing:.1em;text-transform:uppercase;color:var(--gray);margin-bottom:8px">정산 비교</div><div class="tbl-wrap st-table-wrap"><table class="st-table"><colgroup><col class="st-col-cat"><col><col><col><col></colgroup><thead><tr style="color:var(--gray)"><th class="st-first" style="text-align:left;padding:4px 6px;font-size:13px">분류</th><th style="text-align:right;padding:4px 6px;font-size:13px">'+current+'</th><th style="text-align:right;padding:4px 6px;font-size:13px">예산대비</th><th style="text-align:right;padding:4px 6px 4px 18px;font-size:13px">'+previous+'</th><th style="text-align:right;padding:4px 6px;font-size:13px">증감</th></tr></thead><tbody>'+body+'</tbody></table></div></div>';
}
